...
Articulo* articulo_newParametros(char* idStr, char* codigo, char* nombre, char* descripcion, char* fobStr, char* pArancelariaStr, char* anchoStr, char* altoStr, char* profundidadStr, char* pesoStr, char* paisFabricacion);
