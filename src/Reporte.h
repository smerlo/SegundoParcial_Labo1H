...
Reporte* reporte_newParametros(char* idStr, char* codigo, char* nombre, char* descripcion, char* fobStr, char* pArancelariaStr,	char* mCubicosStr, char* cmCubicosStr, char* valorAereoStr, char* valorMaritimoStr);
